...
export interface TrashRecord {
  ...
  deletedBySurname?: string;   // surname of the actor at time of deletion
  deletedByUserId?: string;    // readable userId (e.g. ST-2601-00001) of the actor
    ...
    try {
      ...
      return snapshot.docs.map((docSnap) => {
        ...
        return {
          ...
          deletedBySurname: data.deletedBySurname ?? '',
