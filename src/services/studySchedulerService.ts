...
function buildDaySlots(
  ...
  for (
    ...
    // FIX: strict less-than — do NOT schedule sessions on the deadline/exam day itself.
    // Previously `d <= end` included the exam day, placing sessions at e.g. 10:00 on
    // the day of the exam, which is both confusing and unhelpful.
    d < end;
    d = addDays(d, 1)
  ) {
