...
export interface MCQQuestion {
  id: string;
  title: string; // Added for ContentUpload compatibility
  description: string; // Added for ContentUpload compatibility
  question: string;
  choices: MCQChoice[];
  ...
  course: string;
  tags: string[];
  type: 'mcq'; // Added for ContentUpload compatibility
  createdBy: string;
  createdAt: Date;
  updatedAt?: Date;
}
