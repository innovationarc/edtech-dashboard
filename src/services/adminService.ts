    ...
    try {
      ...
      try {
        ...
        const logData = {
          ...
          changes: `{"action":"password_reset","targetAdminUid":"${uid}","targetAdminUserId":"${adminUserId}","targetAdminSurname":"${adminSurname}","performedByUid":"${performerUid}","performedByUserId":"${performerUserId}","performedBySurname":"${performerSurname}","reason":"${resetReason || 'No reason provided'}","timestamp":"${new Date().toISOString()}"}`,
          fieldChanges: [
