...
const sendAdminEditSMS = async (
  ...
  // Format field changes with old → new format
  const changesDetails = fieldChanges.map(change => 
...
If you did not request these changes or have any concerns, please contact other administrators immediately.
