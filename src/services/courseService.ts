...
// Course Service - Complete with Error Handling
...
export const courseService = {
  ...
  async calculateEnrollmentPrice(
    ...
    try {
      console.log('💰 Calculating price:', { courseId, studentId, couponCode });
      ...
      console.log('Price calculation:', { basePrice, totalDiscount, finalPrice });
  ...
  async createFreeEnrollment(
    ...
    try {
      ...
      console.error('❌ Free enrollment error:', error.message);
      return {
        success: false,
  ...
  async initiatePaidEnrollment(
    ...
    try {
      ...
      console.error('❌ Paid enrollment error:', error.message);
      return {
        success: false,
