// src/services/qaService.ts - Part 1 of 3 (Enhanced with Tesseract.js OCR & Advanced Similarity Detection)
import {
  collection,
  doc,
  getDocs,
...
export const qaService = {
  ...
  // OCR: Extract text from image using Tesseract.js (client-side)
  async extractTextFromImage(imageUrl: string): Promise<string> {
    try {
      ...
      const result = await Tesseract.recognize(
        imageUrl,
        'eng+ben', // Support for English and Bengali
        {
          logger: (m) => {
...
// src/services/qaService.ts - Part 2 of 3 (Advanced Similarity Detection with Image Priority)
...
// src/services/qaService.ts - Part 3 of 3 (Listeners and Enhanced Data Management)
