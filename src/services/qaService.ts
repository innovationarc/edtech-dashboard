// src/services/qaService.ts - Part 1 of 2 (Enhanced with Rating Editing, Course Deletion, Voice Support)
import {
  collection,
  doc,
  getDocs,
...
// src/services/qaService.ts - Part 2 of 2 (Continuation with Course Deletion Support)
