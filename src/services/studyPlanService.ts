...
export const studyPlanService = {
   ...
   */
  /**
   * Returns the highest "Session N" number found in event titles for the given
   * student + subject. Used to safely continue session numbering after reschedule.
   * Queries Firestore directly so it's never stale even if React state is behind.
   */
