// src/services/contentService.ts - UPDATED VERSION WITH EDIT SUPPORT
...
export const contentService = {
  ...
  async createContent(
    ...
    try {
      ...
      // Build the content object with only defined fields
  ...
  async updateContent(
    ...
    try {
      ...
      // Only update file URLs if they are provided
      ...
      // Update exam-specific fields only if type is exam
