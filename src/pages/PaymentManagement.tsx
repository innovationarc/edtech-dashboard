              ...
              <div className="rounded-xl border border-red-500/20 bg-red-500/8 p-4 space-y-2">
                ...
                <div className="grid grid-cols-2 gap-3 text-xs">
                  <div>
                    ...
                    {viewRecord.deletedBySurname && viewRecord.deletedByName && viewRecord.deletedBySurname !== viewRecord.deletedByName && (
                      <p className="text-gray-500 text-[10px]">{viewRecord.deletedByName}</p>
                    )}
              ...
              <div key={record.id} className="rounded-xl border border-white/5 bg-[#0f1117] p-4 space-y-3">
                ...
                <div className="grid grid-cols-2 gap-2 text-xs">
                  <div>
                    ...
                    {record.deletedBySurname && record.deletedByName && record.deletedBySurname !== record.deletedByName && (
                      <p className="text-gray-500 text-[10px]">{record.deletedByName}</p>
                    )}
