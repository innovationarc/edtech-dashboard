...
import {
  ...
  BookOpen, Phone, Tag, History, Undo2, FileText,
} from 'lucide-react';
import {
  paymentService,
  Transaction,
...
const DetailModal = ({
  txn, readableUserId, userPhone, onClose, onDelete, onChangeStatus, onViewReceipt, canModify,
}: {
  txn: Transaction;
    ...
    <div className="space-y-6 pb-10">
      ...
      {selectedTxn && (
        <DetailModal
          ...
          onViewReceipt={() => handleViewReceipt(selectedTxn.transactionId)}
          canModify={canModify}
        />
      )}
