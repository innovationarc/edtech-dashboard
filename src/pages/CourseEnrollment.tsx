...
const CourseEnrollment = () => {
  ...
  useEffect(() => {
    ...
    const handleReturn = async () => {
      ...
      // We still call completeEnrollmentAfterPayment which is idempotent — it will
      // detect the existing enrollment and return alreadyEnrolled:true, then we
      // show success and reload the course list.
      setPaymentReturn({
        active: true,
        status: 'processing',
        message: enrolledParam === 'true'
