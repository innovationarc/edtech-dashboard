...
// ─── Shared modal shell — exact same style as ComingSoon.tsx ─────────────────
const ModalShell = ({ children, onClose, wide, narrow }: {
  ...
  const maxW = wide ? '800px' : narrow ? '460px' : '520px';
...
const CEStyles = ({ primaryColor: pc, accentColor: ac }: { primaryColor: string; accentColor: string }) => {
  ...
  <style>{`
    ...
    .ce-filter-toggle:hover{border-color:var(--ce-bd2);color:var(--ce-tx);background:var(--ce-s2)}
    ...
    .ce-filters{
      ...
      background:var(--ce-s2);border:1px solid var(--ce-bd);border-radius:16px;padding:.875rem
    }
    ...
    .ce-search{width:100%;box-sizing:border-box;background:var(--ce-s3);border:1px solid var(--ce-bd);color:var(--ce-tx);border-radius:12px;padding:10px 32px 10px 36px;font-size:.875rem;outline:none;transition:border-color .18s,box-shadow .18s;font-family:inherit}
    ...
    .ce-custom-sel-trigger{
      ...
      background:var(--ce-s3);border:1px solid var(--ce-bd);color:var(--ce-tx);
