...
const CEStyles = () => (
  <style>{`
    ...
    .ce-tabs{display:flex;flex:1;min-width:0;position:relative}
    ...
    .ce-tab:hover{color:var(--ce-tx);background:rgba(255,255,255,.03)}
    .ce-tab--on{color:var(--ce-blue);border-bottom-color:transparent}
    ...
    .ce-overlay{
      ...
      overflow:hidden;
      animation:ce-overlay-in .2s ease
    }
    ...
    /* Modal: proper flex layout, no cutoff */
    .ce-modal{
      background:#131921;
      ...
      animation:ce-modal-in .24s cubic-bezier(.22,.68,0,1.1)
    }
    .ce-modal--wide{max-width:800px}
    .ce-modal--narrow{max-width:460px;overflow-x:hidden}
    @keyframes ce-modal-in{from{opacity:0;transform:scale(.96) translateY(16px)}to{opacity:1;transform:scale(1) translateY(0)}}
    ...
    .ce-modal-body:hover{scrollbar-color:var(--ce-bd2) transparent}
    .ce-modal-body::-webkit-scrollbar{width:4px}
    .ce-modal-body::-webkit-scrollbar-track{background:transparent}
    .ce-modal-body::-webkit-scrollbar-thumb{background:transparent;border-radius:4px;transition:background .3s}
    .ce-modal-body:hover::-webkit-scrollbar-thumb{background:var(--ce-bd2)}
    ...
    @media(max-width:479px){
      ...
      .ce-modal--wide,.ce-modal--narrow{max-height:calc(100dvh - 24px);border-radius:var(--ce-rl)}
      .ce-overlay{padding:.75rem}
      .ce-overlay--top{padding:.75rem;padding-top:12px;align-items:flex-start}
