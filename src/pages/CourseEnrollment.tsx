...
const CEStyles = () => (
  <style>{`
    ...
    .ce-search{width:100%;box-sizing:border-box;background:var(--ce-s2);border:1px solid var(--ce-bd);color:var(--ce-tx);border-radius:var(--ce-r);padding:9px 30px 9px 34px;font-size:.85rem;outline:none;transition:border-color .18s,box-shadow .18s;font-family:inherit}
    ...
    .ce-card--list{flex-direction:row;align-items:stretch}
    .ce-card--list .ce-card-thumb{width:160px;min-width:160px;height:auto;min-height:130px;flex-shrink:0;overflow:hidden}
    .ce-card--list .ce-card-thumb .ce-card-img{width:100%;height:100%;object-fit:cover;display:block}
    .ce-card--list .ce-card-thumb .ce-card-fallback{width:100%;height:100%;min-height:130px}
    .ce-card--list .ce-card-body{flex:1;min-width:0;display:flex;flex-direction:column;gap:.4rem;padding:.875rem}
    .ce-card--list .ce-card-actions{margin-top:auto;flex-direction:row}
    .ce-card--list .ce-price-row{margin-top:0}
    @media(min-width:560px){
      .ce-card--list .ce-card-thumb{width:220px;min-width:220px;min-height:150px}
    }
    @media(max-width:400px){
      .ce-card--list{flex-direction:column}
      .ce-card--list .ce-card-thumb{width:100%;min-height:160px;height:160px}
    }
