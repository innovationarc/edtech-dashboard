...
const CourseEnrollment = () => {
  ...
  useEffect(() => {
    // Check for enrollment success flag (from payment-success page or API redirect)
    ...
    if (enrolled === 'true') {
      ...
      setWarning('Payment is being validated. This may take a few moments. Please check your enrolled courses.');
      setActiveTab('enrolled');
      // Clean URL
      searchParams.delete('status');
      searchParams.delete('tran_id');
