        ...
        <div className="ce-modal ce-modal--narrow" role="dialog" aria-modal="true">
          ...
          <div className="ce-modal-body">
            ...
            {calculation.finalPrice > 0 && !enrolling && (
              <p style={{ textAlign: 'center', fontSize: '0.72rem', color: 'var(--ce-tx3)', marginTop: '0.25rem', display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '0.25rem' }}>
...
const CEStyles = () => (
  <style>{`
    ...
    .ce-modal{
      ...
      /* max-height uses viewport minus top padding so content scrolls, never clips */
