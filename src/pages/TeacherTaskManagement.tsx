...
const TeacherTaskManagement: React.FC = () => {
  ...
  const [teacherTaskPerms, setTeacherTaskPerms] = useState<
    Array<{ courseId: string; courseTitle: string; allowedSubjects: string[]; subjects?: string[]; class?: string }>
  >([]);
  ...
  const load = useCallback(async (
    taskPerms?: Array<{ courseId: string; courseTitle: string; allowedSubjects: string[]; subjects?: string[]; class?: string }>
  ) => {
    if (!user) return;
