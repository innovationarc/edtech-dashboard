...
const StudentStudyPlan = () => {
  ...
  return (
    ...
    </div>{/* closes: view content wrapper */}
    </div>{/* closes: analytics / chat / list / calendar section */}
    </div>{/* closes: section container */}
    </div>{/* closes: inner column */}
    </div>{/* closes: goals panel or side panel */}
    </div>{/* closes: layout row */}
    </div>{/* closes: tab content area */}
    </div>{/* closes: tab panel */}
    </div>{/* closes: goals list wrapper */}
    </div>{/* closes: goals section */}
    </div>{/* closes: pomodoro / timer section */}
    </div>{/* closes: pomodoro card inner */}
    </div>{/* closes: pomodoro card */}
    </div>{/* closes: sidebar column */}
    </div>{/* closes: main flex row */}
    </div>{/* closes: page body */}
    </div>{/* closes: header + body wrapper */}
    </div>{/* closes: page container */}
    </div>{/* closes: NoAnimCard inner */}
    </div>{/* closes: outer wrapper */}
    </div>{/* closes: outer wrapper 2 */}
    </div>{/* closes: root return div */}
  );
};
