    ...
    <div style={{ display: 'flex', flexDirection: 'column', gap: 20, fontFamily: "'Outfit',sans-serif" }}>
      ...
      <div style={{ display: 'flex', gap: 4, background: T.surface, border: `1px solid ${T.border}`, padding: 4, borderRadius: 16, flexWrap: 'wrap', width: 'fit-content', maxWidth: '100%' }}>
        {([
          ...
          <button key={t.id} onClick={() => setView(t.id)} style={{ display: 'flex', alignItems: 'center', gap: 6, padding: '8px 14px', borderRadius: 12, fontSize: 13, fontWeight: 600, border: 'none', cursor: 'pointer', fontFamily: "'Outfit',sans-serif", background: 'transparent', color: view === t.id ? T.primaryColor : T.text2, transition: 'color 0.15s', whiteSpace: 'nowrap' as const, position: 'relative' as const }}>
