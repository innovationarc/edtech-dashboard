      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: 12 }}>
        ...
        <div className="ssp-btn-grid">
          ...
          {aiReady && goals.length > 0 ? (
            <div style={{ position: 'relative', gridColumn: 'auto' }} ref={freeTimePanelRef}>
              <button
              ...
              {showFreeTimePanel && (
                <div style={{ position: 'absolute', left: 0, top: '100%', marginTop: 8, zIndex: 40, width: 300, maxWidth: 'calc(100vw - 2rem)', background: T.baseBg, border: `1px solid ${T.border}`, borderRadius: 18, boxShadow: '0 12px 40px rgba(0,0,0,0.4)', padding: '14px 16px', display: 'flex', flexDirection: 'column', gap: 12 }}>
