...
const StudentStudyPlan = () => {
  ...
  const handleSendChat = async () => {
    ...
    try {
      const { response, calendarEvents, goals } = await aiStudyPlannerService.chatWithAI(
      ...
      const assistantMsg = { role: 'assistant' as const, content: response, calendarEvents, goals };
    ...
    <div className="space-y-6">
      ...
      {view === 'chat' && (
        <Card>
            ...
            <div className="flex items-center gap-3 bg-background-800 border border-background-600 rounded-xl px-3 py-2 mb-2">
              ...
              <div className="flex-1 min-w-0">
                {chatImageOCRLoading ? (
                  ...
                  <div>
                    <p className="text-xs text-emerald-400 font-medium">✓ Schedule image analyzed</p>
          ...
          <p className="text-xs text-gray-600 mt-1.5 text-center">📸 Tip: Upload your exam routine or class timetable image — Minerva will read it and plan around it</p>
        </Card>
      )}
