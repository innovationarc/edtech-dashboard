      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
        {[
          ...
          <div key={s.label} className={`bg-gradient-to-br ${s.cls} border rounded-2xl p-4 relative`}>
            ...
            {s.id === 'streak' && streakFreezeCount > 0 && (
              <button
                onClick={() => setShowFreezePrompt(true)}
                title="Use a streak freeze to protect your streak"
                className="absolute top-3 right-3 flex items-center gap-1 bg-cyan-500/20 border border-cyan-500/30 text-cyan-300 text-xs px-1.5 py-0.5 rounded-full hover:bg-cyan-500/30 transition-colors"
              >
