...
// PASTE THIS FIRST, THEN IMMEDIATELY PASTE PART 2, THEN PART 3
...
const ContentUpload = () => {
  ...
  const validateFile = (file: File): boolean => {
    const maxSize = formData.courseId ? 500 * 1024 * 1024 : 100 * 1024 * 1024; // 500MB or 100MB
...
// src/pages/ContentUpload.tsx - PART 3 OF 3 (FINAL)
// PASTE THIS IMMEDIATELY AFTER PART 2 TO COMPLETE THE FILE
