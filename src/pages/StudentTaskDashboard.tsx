...
const TaskModal = ({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-end sm:items-center justify-center bg-black/60 backdrop-blur-sm">
      <Card className="w-full sm:max-w-xl !rounded-t-2xl sm:!rounded-2xl shadow-2xl flex flex-col !p-0" style={{ maxHeight: '92dvh' }}>
        {/* Header */}
...
const GroupCard = ({
  ...
  return (
    <Card className="overflow-hidden transition-all w-full !p-0">
    ...
    <div className="w-full max-w-full overflow-x-hidden box-border" style={{ padding: '16px 12px', display: 'flex', flexDirection: 'column', gap: 16 }}>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 10 }}>
        {[
          ...
          <Card key={s.label} className="min-w-0 !p-3">
