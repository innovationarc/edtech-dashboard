...
const useThemeTokens = () => {
  ...
  const card = (): React.CSSProperties => {
    switch (cs) {
      case 'liquid':        return { background: isLight ? 'rgba(255,255,255,0.65)' : 'rgba(255,255,255,0.05)', backdropFilter:'blur(16px)', border:`1px solid ${border}` };
      case 'crystal':       return { background: isLight ? 'rgba(255,255,255,0.75)' : 'rgba(22,26,37,0.82)',    backdropFilter:'blur(12px)', border:`1px solid ${border}` };
      case 'glassmorphism': { const [r,g,b]=hexToRgb(primaryColor); return { background:`rgba(${r},${g},${b},0.10)`, backdropFilter:'blur(12px)', border:`1px solid rgba(${r},${g},${b},0.25)` }; }
      case 'frost':         { const [r,g,b]=hexToRgb(primaryColor); return { background:`rgba(${r},${g},${b},0.08)`, backdropFilter:'blur(10px)', border:`1px solid ${border}` }; }
      case 'neon':          return { background: isLight ? '#ffffff' : 'rgba(8,8,20,0.88)', border:`1px solid ${primaryColor}55`, boxShadow:`0 0 12px ${primaryColor}22` };
      ...
      case 'matte':         return { background: isLight ? 'rgba(255,255,255,0.90)' : 'rgba(22,26,37,0.82)',    backdropFilter:'blur(8px)',  border:`1px solid ${border}` };
      default:              return { background: isLight ? '#ffffff' : 'var(--color-card,#1a1f2e)',              border:`1px solid ${border}` };
    }
  };
