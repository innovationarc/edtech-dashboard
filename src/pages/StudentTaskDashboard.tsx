  ...
  return (
    <div data-no-anim>
      <style>{`
        ...
        .std-task-btn { -webkit-tap-highlight-color: transparent !important; outline: none !important; }
        .std-task-btn:focus { outline: none !important; box-shadow: none !important; }
        .std-task-btn:active { background-color: transparent !important; }
      `}</style>
  ...
  if (!document.getElementById(styleId)) {
    ...
    s.textContent = `
      * { -webkit-tap-highlight-color: transparent !important; }
      button, a, [role="button"] { outline: none !important; -webkit-tap-highlight-color: transparent !important; }
  ...
  return (
    <NoAnimCard className="overflow-hidden transition-all w-full !p-0">
      <button
        ...
        className="std-task-btn w-full text-left p-4 hover:bg-white/5 transition-colors"
