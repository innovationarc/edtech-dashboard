  ...
  return (
    <NoAnimCard className="overflow-hidden transition-all w-full !p-0">
      <button
        ...
        className="w-full text-left p-4 hover:bg-white/5 transition-colors outline-none"
                ...
                <div key={task.id} className="flex items-center gap-2 p-3 rounded-xl transition-colors mt-2"
                  ...
                  <div className="flex items-center gap-1.5 shrink-0">
                    ...
                    <button onClick={() => onOpenTask(task, sub)}
                      className="px-2.5 py-1.5 rounded-lg text-xs font-medium text-white transition-opacity hover:opacity-80 outline-none"
