// src/pages/QuestionDetail.tsx - Part 1 of 5 (Enhanced with AI Context & Working OCR)
...
// src/pages/QuestionDetail.tsx - Part 2 of 5 (Main Render & Question Menu)
...
// src/pages/QuestionDetail.tsx - Part 4 of 5 (Answer Cards & Edit Modal)
    ...
    try {
      ...
      if (attachedFile) {
        ...
        if (fileType === 'image') {
          ...
          // Extract OCR text from new image
          console.log('🖼️ New image uploaded, extracting OCR text...');
          const extractedText = await qaService.extractTextFromImage(uploadResult.url);
          updates.extractedText = extractedText || undefined;
...
// src/pages/QuestionDetail.tsx - Part 5 of 5 (Follow-up Modal with AI Context & Viewers)
...
const FollowUpQuestionModal = ({ parentQuestion, parentAnswers, onClose, onSuccess, renderFormattedText }: FollowUpQuestionModalProps) => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (parentQuestion.answeredBy === 'ai') {
        console.log('🤖 Generating AI follow-up answer with conversation context...');
        ...
        // Build conversation context with previous Q&A
...
Provide a comprehensive answer to their follow-up question:`;
        ...
        console.log('📝 AI Prompt prepared with conversation history');
        ...
        console.log('📤 Follow-up question created:', followUpId);
        ...
        notificationService.createNotification({
          userId: parentQuestion.studentId,
        ...
        console.log('✅ AI answer saved for follow-up question');
      } else {
        // Teacher/Admin answered - just create follow-up question
        console.log('👨‍🏫 Creating follow-up question for teacher/admin to answer');
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
      <div className="bg-background-900 rounded-xl w-full max-w-2xl p-6 max-h-[90vh] overflow-y-auto">
        ...
        {parentAnswers.length > 0 && (
          <div className="bg-background-800 rounded-lg p-4 mb-4">
            <p className="text-sm text-gray-400 mb-2">Previous Answer:</p>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          {parentQuestion.answeredBy === 'ai' && (
            <div className="bg-purple-900/20 border border-purple-500/30 rounded-lg p-3 text-sm text-purple-200">
              <p className="font-medium mb-1">🤖 AI Follow-up</p>
              <p>Since this was answered by AI, your follow-up will also be answered by AI with full context of the previous conversation.</p>
            </div>
          )}
