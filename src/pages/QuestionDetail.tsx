  ...
  return (
    <>
      ...
      <style>{`
        ...
        .qd-sidebar { flex-shrink: 0; width: 288px; display: flex; flex-direction: column; }
        .qd-main { flex: 1; min-width: 0; display: flex; flex-direction: column; gap: 16px; }
        /* Hide sidebar entirely on mobile — only show main content */
        ...
        <div className="qd-sidebar">
          <div style={{ position: 'sticky', top: 24 }}>
            ...
            >
              ...
              {showQuestionMenu ? 'Hide List' : 'Show List'}
            </button>
