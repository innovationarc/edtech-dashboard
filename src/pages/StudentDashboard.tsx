    ...
    <div style={{display:'flex',flexDirection:'column',gap:'clamp(18px,2.8vw,30px)',fontFamily:"'Outfit',sans-serif"}}>
      ...
      <div style={{animation:'cardReveal 500ms cubic-bezier(0.22,1,0.36,1) 0ms both'}}>
        <div className="flex items-start justify-between">
          <h1 style={{fontSize:'clamp(1.2rem,2.5vw,1.6rem)',fontWeight:800,color:T.text,margin:0,lineHeight:1.25,flex:1,minWidth:0}}>
        ...
        <p style={{color:T.text2,fontSize:14,margin:'4px 0 0'}}>Ready to conquer your learning goals today?</p>
      </div>
