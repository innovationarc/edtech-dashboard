...
const StudentDashboard = () => {
  ...
  useEffect(() => {
    ...
    // NEW loaders
    loadKPI(); loadContinueLearning(); loadAllCourses(); loadPendingTasks(); loadExamPerf(); loadStudyHeatmap(); loadAppHeatmap();
  ...
  const loadEnrolledCourses = async () => {
    ...
    try {
      ...
      // Fire-and-forget: sync live class attendance → content progress for every enrolled course
      courses.forEach(c => {
        contentProgressService.syncProgressForCourse(user.uid, c.courseId).catch(() => {});
      });
    } catch {}
  };
