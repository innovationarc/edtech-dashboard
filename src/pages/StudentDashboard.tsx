          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 6 }}>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: isMobile ? 'repeat(2,1fr)' : 'repeat(4,1fr)', gap: 'clamp(8px,1.2vw,12px)' }}>
              {cards.map((s, i) => frozen ? (
                // ── Frozen card: natural glacier ice with crystal cracks ──
                <div key={i} style={{
                  position: 'relative', overflow: 'hidden', borderRadius: 14,
                  padding: '10px 12px',
                  background: dark ? 'rgba(6,16,38,0.92)' : 'rgba(215,238,255,0.72)',
                  border: 'none', boxShadow: 'none',
                }}>

                  {/* Edge frost ring — dense opaque crust, clear center */}
                  <div style={{ position: 'absolute', inset: 0, zIndex: 1, pointerEvents: 'none',
                    background: dark
                      ? 'radial-gradient(ellipse 88% 88% at 50% 50%, transparent 28%, rgba(147,197,253,0.30) 55%, rgba(147,197,253,0.75) 78%, rgba(186,230,253,0.94) 100%)'
                      : 'radial-gradient(ellipse 88% 88% at 50% 50%, transparent 26%, rgba(96,165,250,0.24) 52%, rgba(59,130,246,0.62) 76%, rgba(37,99,235,0.82) 100%)',
                  }} />

                  {/* Corner ice clusters */}
                  <div style={{ position: 'absolute', inset: 0, zIndex: 2, pointerEvents: 'none',
                    background: dark
                      ? 'radial-gradient(ellipse 50% 58% at 0% 0%, rgba(186,230,253,0.96) 0%, rgba(147,197,253,0.62) 30%, transparent 62%), radial-gradient(ellipse 50% 58% at 100% 0%, rgba(186,230,253,0.96) 0%, rgba(147,197,253,0.62) 30%, transparent 62%), radial-gradient(ellipse 50% 58% at 0% 100%, rgba(186,230,253,0.96) 0%, rgba(147,197,253,0.62) 30%, transparent 62%), radial-gradient(ellipse 50% 58% at 100% 100%, rgba(186,230,253,0.96) 0%, rgba(147,197,253,0.62) 30%, transparent 62%)'
                      : 'radial-gradient(ellipse 50% 58% at 0% 0%, rgba(96,165,250,0.94) 0%, rgba(59,130,246,0.55) 30%, transparent 62%), radial-gradient(ellipse 50% 58% at 100% 0%, rgba(96,165,250,0.94) 0%, rgba(59,130,246,0.55) 30%, transparent 62%), radial-gradient(ellipse 50% 58% at 0% 100%, rgba(96,165,250,0.94) 0%, rgba(59,130,246,0.55) 30%, transparent 62%), radial-gradient(ellipse 50% 58% at 100% 100%, rgba(96,165,250,0.94) 0%, rgba(59,130,246,0.55) 30%, transparent 62%)',
                  }} />

                  {/* Crystal crack network — branching fractures unique per card */}
                  <svg viewBox="0 0 100 100" preserveAspectRatio="none"
                    style={{ position: 'absolute', inset: 0, width: '100%', height: '100%', zIndex: 3, pointerEvents: 'none' }}>
                    {/* Frost glow along crack lines */}
                    {[
                      ["M5,8 L22,18 L18,32 L35,28 M22,18 L30,12 M18,32 L12,45 L28,52","M85,5 L75,20 L82,35 M75,20 L65,28 L70,42 M65,28 L55,22","M3,75 L18,68 L28,78 L22,90 M18,68 L25,58","M70,80 L80,70 L95,75 M80,70 L78,58 L88,50"],
                      ["M10,5 L25,22 L20,38 M25,22 L38,18 L45,30 M38,18 L42,8","M80,10 L68,25 L75,40 L62,48 M68,25 L60,18","M5,85 L20,75 L30,85 M20,75 L15,62 L28,55 M15,62 L8,55","M75,90 L85,78 L95,82 M85,78 L82,65 L92,58"],
                      ["M8,12 L20,25 L15,40 L28,48 M20,25 L32,20 M15,40 L8,52","M88,8 L72,22 L78,38 M72,22 L62,15 L55,25 M62,15 L65,5","M5,78 L22,70 L18,85 M22,70 L32,62 L38,72","M80,85 L88,72 L95,78 M88,72 L85,60 L95,55 M85,60 L75,55"],
                      ["M12,5 L28,20 L22,35 M28,20 L40,15 L48,25 M40,15 L38,5","M85,12 L70,28 L80,42 L68,50 M70,28 L58,20 M80,42 L88,38","M8,80 L25,72 L20,88 M25,72 L35,65 M25,72 L18,62","M72,88 L82,75 L95,80 M82,75 L80,62 L90,55"],
                    ][i % 4].map((p, ci) => (
                      <g key={ci}>
                        <path d={p} stroke="rgba(255,255,255,0.50)" strokeWidth="2.8" fill="none" strokeLinecap="round" strokeLinejoin="round"/>
                        <path d={p} stroke={dark ? "rgba(220,242,255,0.92)" : "rgba(30,64,175,0.72)"} strokeWidth="0.75" fill="none" strokeLinecap="round" strokeLinejoin="round"/>
                      </g>
                    ))}
                  </svg>

                  {/* Light refraction glints */}
                  <div style={{ position: 'absolute', top: 7, left: 9, width: 24, height: 11, zIndex: 4, pointerEvents: 'none',
                    background: 'radial-gradient(ellipse, rgba(255,255,255,0.80) 0%, transparent 70%)',
                    borderRadius: '50%', transform: 'rotate(-15deg)', filter: 'blur(1px)',
                  }} />
                  <div style={{ position: 'absolute', bottom: 9, right: 11, width: 15, height: 7, zIndex: 4, pointerEvents: 'none',
                    background: 'radial-gradient(ellipse, rgba(255,255,255,0.60) 0%, transparent 70%)',
                    borderRadius: '50%', filter: 'blur(0.5px)',
                  }} />

                  {/* Frosted glass — desaturates content behind ice */}
                  <div style={{ position: 'absolute', inset: 0, zIndex: 5, pointerEvents: 'none',
                    backdropFilter: 'blur(3px) saturate(0.38) brightness(0.84)',
                    WebkitBackdropFilter: 'blur(3px) saturate(0.38) brightness(0.84)',
                  }} />

                  {/* Card content */}
                  <div style={{ position: 'relative', zIndex: 6, display: 'flex', flexDirection: 'column', gap: 5 }}>
                    ...
                    <p style={{ fontSize: 'clamp(1.1rem,2vw,1.35rem)', fontWeight: 800, margin: 0, lineHeight: 1,
                      ...
                      textShadow: dark ? '0 0 12px rgba(147,197,253,0.70)' : 'none' }}>{s.value}</p>
