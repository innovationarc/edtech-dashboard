    ...
    <div style={{display:'flex',flexDirection:'column',gap:'clamp(18px,2.8vw,30px)',fontFamily:"'Outfit',sans-serif"}}>
      ...
      <div style={{animation:'cardReveal 500ms cubic-bezier(0.22,1,0.36,1) 0ms both'}}>
        <div className="flex items-start justify-between">
          <h1 style={{fontSize:'clamp(1.2rem,2.5vw,1.6rem)',fontWeight:800,color:T.text,margin:0,lineHeight:isMobile?1.25:1.15,flex:1,minWidth:0}}>
            <span>Welcome back, </span>
            <span style={{display:'inline-block'}}>{user?.name || 'Student'}! 🌟</span>
          </h1>
          <div className="text-right" style={{flexShrink:0,marginLeft:12,display:'flex',flexDirection:'column',alignItems:'flex-end',paddingTop:isMobile?0:4}}>
        ...
        <p style={{color:T.text2,fontSize:14,margin:`${isMobile?4:1}px 0 0`}}>Ready to conquer your learning goals today?</p>
      </div>
