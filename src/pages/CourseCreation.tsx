// src/pages/CourseCreation.tsx - Part 1
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <Card title="Course Information">
          <div className="space-y-4">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div>
                ...
                <input
                  ...
                  disabled={loading}
                />
                <p className="text-xs text-gray-500 mt-1">Enter course category (will be used for filtering)</p>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                ...
                <input
                  ...
                  className="w-full bg-background-800 text-white rounded-lg py-3 px-4 focus:outline-none focus:ring-2 focus:ring-primary-500"
                  placeholder="e.g., Class 6, Class 10, Grade 12..."
                  disabled={loading}
                />
                <p className="text-xs text-gray-500 mt-1">Enter target class/grade (will be used for filtering)</p>
              </div>
            ...
            <div className="bg-background-800 p-4 rounded-lg border border-primary-900">
              <p className="text-sm text-gray-400">
                <strong className="text-white">Note:</strong> Course duration will be automatically calculated based on the total time of all lessons you add from the Content Upload page.
              </p>
            </div>
          </div>
        </Card>

// src/pages/CourseCreation.tsx - Part 2 (continued from Part 1)

        {/* Subjects */}
        <Card title="Course Subjects">
          <div className="space-y-4">
            ...
            <div className="bg-background-800 p-3 rounded-lg">
              <p className="text-xs text-gray-400">
                <strong className="text-white">Info:</strong> These subjects will be used for Q&A filtering. Students can ask questions related to these subjects for this course.
              </p>
            </div>
          </div>
        </Card>
