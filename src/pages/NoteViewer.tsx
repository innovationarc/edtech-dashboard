...
// ─── NoAnimCard — same pattern as StudentTaskDashboard.tsx ────────────────────
      ...
      >
        ...
        <div className="relative max-w-4xl mx-auto px-4 sm:px-6 py-6 sm:py-8 space-y-5 sm:space-y-6">
          ...
          <NoAnimCard className="p-0 overflow-hidden">
            ...
            >
              {/* Accent tint — pure overlay, no opaque bg */}
              <div
                className="absolute inset-0 pointer-events-none"
                style={{ background: `linear-gradient(135deg, rgba(${pRgb},0.08) 0%, rgba(${pRgb},0.02) 50%, transparent 100%)` }}
                aria-hidden="true"
              />
              {/* Badge row */}
