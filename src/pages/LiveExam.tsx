        ...
        <div className="grid grid-cols-2 gap-2">
          {[
            ...
            <Card key={label} className="p-3">
              <div style={{ width: 26, height: 26, borderRadius: 7, background: `rgba(${pRgb},0.15)`, display: 'flex', alignItems: 'center', justifyContent: 'center', marginBottom: 6 }}>
                <Icon size={13} style={{ color }} />
              </div>
              <p style={{ fontSize: 20, fontWeight: 800, color: T.text, margin: 0, lineHeight: 1 }}>{value}</p>
              <p style={{ fontSize: 10, color: T.text3, margin: '3px 0 0' }}>{label}</p>
            </Card>
          ))}
        </div>
