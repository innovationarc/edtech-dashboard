...
const ResultsPage: React.FC<{
  ...
  useEffect(() => {
    // Load leaderboard on mount to get position + highest marks
              ...
              {session.mcqAnswers.length === 0
                ...
                : <>
                  ...
                  <div className="rounded-2xl bg-white/3 border border-white/8 overflow-hidden">
                    ...
                    {content.maxAttempts === 1 && (myRank > 0 || highestMarks !== null) && (
                      <div className="grid grid-cols-2 divide-x divide-white/6">
                        {myRank > 0 && (
                          <div className="py-3 text-center">
                            <p className="text-[11px] text-white/35 mb-0.5">Your Position</p>
                            <p className="text-emerald-400 font-bold text-lg">#{myRank}</p>
                          </div>
                        )}
                        {highestMarks !== null && (
                          <div className="py-3 text-center">
                            <p className="text-[11px] text-white/35 mb-0.5">Highest Marks</p>
                            <p className="text-amber-400 font-bold text-lg">{highestMarks}</p>
                          </div>
                        )}
                      </div>
                    )}
