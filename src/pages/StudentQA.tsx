  ...
  return (
    <ModalShell onClose={onClose} wide>
      ...
      <div style={{
        ...
        {/* Cancel — icon+text on desktop, icon-only on mobile */}
        <button
          onClick={onClose}
          disabled={loading || aiLoading}
          title="Cancel"
        ...
        >
          ...
          {loading ? (
            ...
            <><span className="hidden sm:inline">Teacher </span><span>Q&A Off</span></>
          )}
        </button>
        ...
        >
          ...
          {aiLoading ? (
            ...
            <><span className="hidden sm:inline">AI </span><span>N/A</span></>
          ) : (
            <><span className="hidden sm:inline">AI </span><span>Solve-mate</span></>
          )}
        </button>
      </div>
    </ModalShell>
