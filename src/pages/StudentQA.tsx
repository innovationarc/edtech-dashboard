  ...
  return (
    <ModalShell onClose={onClose} wide>
      ...
      >
        ...
        {/* ── LEFT COLUMN: Form ── */}
        <div
          className={`${hasRightPanel && activeTab !== 'form' ? 'hidden md:flex' : 'flex'} md:w-1/2 w-full`}
          style={{
        ...
        <div
          className={`${hasRightPanel && activeTab !== 'preview' ? 'hidden md:flex' : 'flex'} md:w-1/2 w-full`}
          style={{
            flexDirection: 'column', overflowY: 'auto', padding: '20px 24px',
