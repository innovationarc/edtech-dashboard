...
// ─── NoAnimCard — no animation card (same pattern as StudentTaskDashboard) ────
...
const StudentQA = () => {
  ...
  return (
    <div className="space-y-4 sm:space-y-6">
      ...
      {/* Questions — each as its own NoAnimCard */}
  ...
  return (
    <ModalShell onClose={onClose} wide>
      ...
      <div style={{
        ...
        {/* Cancel — small fixed icon button, sits in the middle */}
        <button
          onClick={onClose}
          disabled={loading || aiLoading}
          title="Cancel"
