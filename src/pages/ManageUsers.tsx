...
import { Trash2, Search, Loader, CheckCircle, XCircle, Clock, RefreshCw, Filter, Info, Edit, Users, GraduationCap, UserCog, Shield, Briefcase, UsersRound, AlertTriangle, X } from 'lucide-react';
...
const UserInfoModal = ({ user, onClose, formatDate }: UserInfoModalProps) => {
  const infoFields = [
    ...
    { label: 'Name', value: user.name || 'N/A', icon: User },
    { label: 'Surname', value: user.surname || 'N/A', icon: User },
