...
import { Trash2, Search, Loader, CheckCircle, XCircle, Clock, RefreshCw, Filter, Info, Edit, Users, GraduationCap, UserCog, Shield, Briefcase, UsersRound, AlertTriangle, X, User as UserIcon, BookOpen, UserCheck } from 'lucide-react';
...
const UserInfoModal = ({ user, onClose, formatDate, formatRoleName, getRoleGradient }: UserInfoModalProps) => {
  const infoFields = [
    ...
    { label: 'Role', value: formatRoleName(user.role) || 'N/A' },
