...
function CourseDetailPage({
  ...
  // Scroll the page/layout container to top when detail opens
  useEffect(() => {
    // Try common scroll containers used by dashboard layouts
    const scrollTargets = [
    ...
    for (const el of scrollTargets) {
      if (el && el.scrollTop > 0) { el.scrollTop = 0; break; }
    }
