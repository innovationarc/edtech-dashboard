  ...
  return (
    ...
    <div data-course-detail-tab style={{
      ...
      <div style={{
        ...
        top: 0,
        zIndex: 10,
        background: T.isLight ? 'rgba(248,250,252,0.95)' : 'color-mix(in srgb, var(--color-bg) 95%, transparent)',
      ...
      <div style={{
        ...
        background: T.isLight ? `linear-gradient(135deg, ${rc}18 0%, transparent 60%)` : `linear-gradient(135deg, ${rc}20 0%, transparent 60%)`,
        borderBottom: `1px solid ${T.border}`,
        padding: '20px 16px',
      }}>
        {/* decorative rings */}
      ...
      {/* ── Tabs ── */}
      <div style={{ display: 'flex', borderBottom: `1px solid ${T.border}`, background: T.isLight ? '#f0f2f5' : 'var(--color-surface)', position: 'sticky', top: 57, zIndex: 9 }}>
        {([
