  ...
  return (
    <>
      ...
      <style>{`
        ...
        /* ── PLAYER: exact negative margins matching DashboardLayout shell padding ──
           Shell uses: p-3 (12px) on mobile, p-4 (16px) on sm, p-6 (24px) on lg
           On desktop (lg+) we want contained rounded player, not full-bleed.    ── */
        .lv-player{
          background:#000;
          overflow:hidden;
          position:relative;
        ...
        /* info cards — no extra side padding needed, shell already provides it */
        .lv-info-wrap{
          padding-bottom:80px;
        }
      ...
      <div className="lv-page" style={{ color:T.text }}
        ...
        {/* ── PLAYER: full-bleed via exact shell padding offsets ── */}
