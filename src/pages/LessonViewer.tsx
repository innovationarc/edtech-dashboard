...
const LessonViewer: React.FC = () => {
  ...
  const T = {
    ...
    // Solid card background — always visible, never just translucent fog
    cardBg:  isLight ? '#ffffff'            : cardBgDark,
    ...
    // Subtle lifted shadow with primary tint — matches ComingSoon hover card
    cardShadow: darkMode
      ? `0 2px 16px rgba(0,0,0,0.45), 0 0 0 1px rgba(${pRgb},0.12)`
