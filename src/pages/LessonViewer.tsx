// src/pages/LessonViewer.tsx — v16
//
// BASE: v10 (proven working, full production player)
//
...
const LessonViewer: React.FC = () => {
  ...
  // Register Service Worker once on mount — must happen before first video load
  useEffect(() => {
              ...
              >
                ...
                {playerState === 'ended' && !isVideoHidden && (
                  <div className="absolute inset-0 flex items-center justify-center bg-black/40 pointer-events-none">
                    <button
                      className="pointer-events-auto w-16 h-16 rounded-full bg-white/15 hover:bg-white/25 backdrop-blur-sm flex items-center justify-content transition-all border border-white/20"
                      onClick={togglePlayPause}>
