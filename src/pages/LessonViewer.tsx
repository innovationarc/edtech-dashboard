  ...
  return (
    <>
      ...
      <style>{`
        ...
        /* ── PADDED SHELL — wraps back button and info, NOT the player ── */
        .lv-padded{ padding-left:16px; padding-right:16px; }

        /* ── PLAYER — always clips children, full width ── */
        .lv-player{
          background:#000;
          overflow:hidden;
          position:relative;
        ...
        /* mobile (<600px): true edge-to-edge — no radius, no shadow */
        /* tablet+ (≥600px): contained with radius + shadow */
      ...
      <div className="lv-page" style={{ color: T.text }} onContextMenu={e => e.preventDefault()}>
        ...
        {/* Back button — padded */}
        <div className="lv-padded" style={{ paddingTop:16, paddingBottom:12 }}>
          <button className="au lv-back" onClick={() => navigate(-1)}>
            <ArrowLeft size={13} /> Back
          </button>
        </div>

        {/* Player — zero side padding on mobile = true edge-to-edge */}
        <div className="lv-padded" style={{ paddingLeft:0, paddingRight:0 }}>
        ...
        {/* Info section — padded */}
        <div className="lv-padded" style={{ paddingBottom:80 }}>
