...
const LessonViewer: React.FC = () => {
  ...
  const T = {
    ...
    // card shadow — matches ComingSoon card hover shadow language
    cardShadow: darkMode
      ? `0 4px 24px rgba(0,0,0,0.35), inset 0 0 0 1px rgba(${pRgb},0.08)`
      : `0 2px 16px rgba(0,0,0,0.07), inset 0 0 0 1px rgba(0,0,0,0.04)`,
    cardShadowHover: darkMode
      ? `0 8px 40px rgba(0,0,0,0.5), inset 0 0 0 1px rgba(${pRgb},0.14)`
      : `0 4px 24px rgba(0,0,0,0.11), inset 0 0 0 1px rgba(0,0,0,0.06)`,
    // icon pill bg — same as ComingSoon status badges
    iconBg:    `rgba(${pRgb},0.12)`,
    iconBorder: `rgba(${pRgb},0.20)`,
  };
  ...
  return (
    <>
      ...
      <style>{`
        ...
        /* ── Video element — hide native controls ── */
        ...
        @media(min-width:900px){
          .lv-meta { grid-template-columns:1fr 300px; }
        }
        ...
        .lv-note-a {
          ...
          gap:8px; padding:12px 16px; border-radius:12px; font-size:13px;
          font-weight:500; text-decoration:none; transition:opacity .15s;
        }
        .lv-note-a:hover { opacity:.80; }
      ...
      >
        {/* Ambient top glow — matches ComingSoon ModalShell glow */}
        <div style={{
          position: 'fixed', inset: 0, pointerEvents: 'none', zIndex: 0,
          background: `radial-gradient(ellipse 80% 45% at 50% -8%, rgba(${pRgb},.16) 0%, transparent 68%)`,
        }} />

        {/* Subtle noise texture overlay — matches ComingSoon ModalShell */}
        <div style={{
          position: 'fixed', inset: 0, pointerEvents: 'none', zIndex: 0,
          ...
          opacity: darkMode ? 0.025 : 0.015,
          mixBlendMode: 'overlay',
        }} />

        {/* Content */}
        <div style={{ position: 'relative', zIndex: 1, maxWidth: 1040, margin: '0 auto', padding: '0 16px 72px' }}>
          ...
          <div style={{ paddingTop: 24, paddingBottom: 4 }}>
            <button
              ...
              onMouseEnter={e => {
                ...
                b.style.background = darkMode ? 'rgba(255,255,255,0.08)' : 'rgba(0,0,0,0.07)';
                b.style.borderColor = `rgba(${pRgb},0.32)`;
              }}
              onMouseLeave={e => {
                const b = e.currentTarget as HTMLButtonElement;
          ...
          <div
            ...
            style={{
              borderRadius: 20,
              overflow: 'hidden',
              border: `1px solid rgba(${pRgb},.20)`,
              background: '#000',
              marginBottom: 16,
              boxShadow: `0 24px 80px rgba(0,0,0,0.7), 0 0 0 1px rgba(${pRgb},.08)`,
            }}
          >
            {/* DevTools overlay */}
            {playerState === 'devtools' && (
              <div style={{
                ...
                alignItems: 'center', justifyContent: 'center', background: '#080a10',
              }}>
          ...
          <div className="lv-meta au2">
            ...
            {/* ── LEFT column: title card + chip cards ── */}
            <div style={{ display: 'flex', flexDirection: 'column', gap: 12 }}>

              {/* Title card — same structure as ComingSoon FeatureCard top section */}
              <div style={{
                background: T.cardBg,
                border: `1px solid ${T.border}`,
                borderRadius: 18,
                padding: '20px 22px',
                boxShadow: T.cardShadow,
                backdropFilter: darkMode ? 'blur(20px) saturate(160%)' : 'none',
                WebkitBackdropFilter: darkMode ? 'blur(20px) saturate(160%)' : 'none',
              }}>
                {/* Type badge — same as ComingSoon status badge pill */}
                ...
                {content?.subject && (
                  <p style={{ color: T.text2, fontSize: 13, margin: '0 0 0', fontWeight: 500 }}>
                    {content.subject}
                  </p>
                )}
                ...
                {content?.description && (
                  <p style={{
                    color: T.text2, fontSize: 13, lineHeight: 1.7,
                ...
                <div className="lv-chips">
                  ...
                  {content?.duration && (
                    <div style={{
                      ...
                      {/* Icon container — matches ComingSoon h-12 w-12 circle */}
                      <div style={{
                      ...
                      <div style={{ minWidth: 0 }}>
                        <p style={{ fontSize: 10, color: T.text3, textTransform: 'uppercase', letterSpacing: '0.07em', fontWeight: 700, margin: '0 0 3px' }}>
                          Duration
                        </p>
                        <p style={{ fontSize: 14, color: T.text, fontWeight: 700, margin: 0 }}>
                          {fmtMinutes(content.duration)}
                        </p>
                      </div>
                    </div>
                  )}
                  ...
                  {content?.subject && (
                    <div style={{
                      ...
                      <div style={{ minWidth: 0, overflow: 'hidden' }}>
                        ...
                        <p style={{ fontSize: 14, color: T.text, fontWeight: 700, margin: 0, overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap' }}>
                          {content.subject}
                        </p>
                      </div>
                    </div>
            ...
            <div>
              {(content?.noteUrl || content?.noteGDrivePreviewUrl) ? (
                ...
                <div style={{
                  ...
                  <div style={{ display: 'flex', flexDirection: 'column', gap: 8, flex: 1 }}>
                    {getNotePreview() && (
                      ...
                      >
                        <span style={{ display: 'flex', alignItems: 'center', gap: 7 }}>
                          <ExternalLink size={14} /> Preview Notes
                        </span>
                    ...
                    {content?.noteSource === 'gdrive' && (
                      <p style={{ fontSize: 10, color: T.text3, textAlign: 'center', margin: '4px 0 0', letterSpacing: '0.03em' }}>
                        via Google Drive
                      </p>
                    )}
                  </div>
                ...
                /* No notes — matches ComingSoon empty-state style */
                <div style={{
                  background: T.cardBg,
                  border: `1px solid ${T.border}`,
                  borderRadius: 18,
                  ...
                  <div style={{
                    ...
                    <FileText size={20} style={{ color: T.text3, opacity: 0.45 }} />
                  </div>
