  ...
  return (
    <>
      ...
      <style>{`
        ...
        /* desktop: title takes remaining width, notes sidebar 280px — stretch = equal height */
        @media(min-width:860px){
          .lv-info{ flex-direction:row; align-items:stretch; gap:14px; }
          .lv-info-main  { flex:1; min-width:0; display:flex; flex-direction:column; }
          .lv-info-aside { width:280px; flex-shrink:0; display:flex; flex-direction:column; }
        }
      ...
      <div className="lv-page" style={{ color: T.text }} onContextMenu={e => e.preventDefault()}>
        <div style={{ maxWidth: 1040, margin: '0 auto', padding: '0 16px 80px' }}>
          ...
          <div className="lv-info au2">
            ...
            {/* LEFT — title card */}
            <div className="lv-info-main" style={{ display:'flex', flexDirection:'column' }}>
            ...
            <div className="lv-info-aside">
              {(content?.noteUrl || content?.noteGDrivePreviewUrl) ? (
                <Card className="p-5 flex flex-col gap-3" style={{ height:'100%' }}>
