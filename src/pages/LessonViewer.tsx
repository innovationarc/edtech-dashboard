      ...
      >
        ...
        <div style={{ position: 'relative', zIndex: 1, maxWidth: 1040, margin: '0 auto', padding: '0 16px 72px' }}>
          ...
          <div style={{ paddingTop: 24, paddingBottom: 4 }}>
            <button
              onClick={() => navigate(-1)}
              className="au inline-flex items-center gap-2 text-sm font-medium text-gray-400 hover:text-white bg-background-700 hover:bg-background-600 border border-white/10 rounded-xl px-4 py-2 mb-5 transition-colors cursor-pointer"
          ...
          <div className="lv-meta au2">
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: 12 }}>
              ...
              {/* Title card — uses app Card component, same as ComingSoon */}
            ...
            <div>
              {(content?.noteUrl || content?.noteGDrivePreviewUrl) ? (
                ...
                <Card className="p-8 flex flex-col items-center justify-center text-center" style={{ minHeight: 120 }}>
                  <div style={{
