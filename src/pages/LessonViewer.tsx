  ...
  return (
    <>
      ...
      <style>{`
        ...
        /* ── PLAYER: full-bleed on mobile, rounded on desktop ── */
        .lv-player{
          background:#000;
          overflow:hidden;
          position:relative;
          /* full viewport width, escape any parent padding */
          width:100vw;
          margin-left:calc(-1 * var(--lv-side,16px));
        }
      ...
      {/* ══════════════════════════════════════════════════════════════════════ */}
      <div className="lv-page" style={{ color:T.text, padding:'0 16px 80px' }}
        onContextMenu={e => e.preventDefault()}>

        {/* ── PLAYER: uses 100vw + negative margin to escape the 16px padding ── */}
