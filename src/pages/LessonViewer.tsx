  ...
  return (
    <>
      ...
      <style>{`
        ...
        /* ── PLAYER ── */
        /* mobile: full-bleed, no radius */
        .lv-player{
          background:#000;
          margin:0 -16px;
          position:relative;
        }
        /* tablet+ : contained with radius + shadow */
        @media(min-width:600px){
          .lv-player{
            margin:0;
            border-radius:14px;
            overflow:hidden;
            box-shadow:0 4px 32px rgba(0,0,0,.6), 0 0 0 1px rgba(255,255,255,.06);
          }
        }
        ...
        /* desktop: title takes remaining width, notes sidebar 280px */
        @media(min-width:860px){
          .lv-info{ flex-direction:row; align-items:flex-start; gap:14px; }
          .lv-info-main  { flex:1; min-width:0; }
          .lv-info-aside { width:280px; flex-shrink:0; }
        }
          ...
          <div className="lv-info au2">
            ...
            <div className="lv-info-main">
              <Card className="p-5">
                ...
                {/* Description */}
                {content?.description && (
                  <p style={{ color:T.text2, fontSize:13, lineHeight:1.6, margin:'8px 0 0' }}>
                    {content.description}
                  </p>
                )}

                {/* Chips — duration + subject inside the card, after a divider */}
                  ...
                  <div className="lv-chips" style={{ borderTop:`1px solid ${T.divider}` }}>
                    {content?.duration && content.duration > 0 && (
                      <span className="lv-chip" style={{ color:T.text2 }}>
                        <Clock size={12} style={{ color:primaryColor, flexShrink:0 }}/>
