...
const RegisterModal = ({ onClose, onSuccess }: RegisterModalProps) => {
  ...
  const handleFormSubmit = async () => {
    ...
    const firstDigit = formData.phoneNumber[0];
    if (!['1', '3', '4', '5', '6', '7', '8', '9'].includes(firstDigit)) {
      setError('Phone number must start with 1, 3, 4, 5, 6, 7, 8, or 9');
      setLoading(false);
      return;
    }
    ...
    try {
      // Format phone number to +8801XXXXXXXXXX
...
// Paste this immediately after Part 1
  ...
  // Registration Form - continues in next message due to length
  return (
        ...
        <div className="relative">
          ...
          <div className="space-y-4 sm:space-y-5">
            ...
            <div className="group">
              ...
              <p className="text-xs text-gray-500 mt-1.5">Enter 10 digits (e.g., 1623737505 or 01623737505)</p>
            </div>
