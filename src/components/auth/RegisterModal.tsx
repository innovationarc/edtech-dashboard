...
const RegisterModal = ({ onClose, onSuccess, onSwitchToSignIn }: RegisterModalProps) => {
  ...
  if (currentStep === 'otp') {
    return (
      <div className="fixed inset-0 bg-black/80 backdrop-blur-sm flex items-start justify-center z-[80] overflow-y-auto p-3 md:p-4">
  ...
  // Render form step
  return (
    <div className="fixed inset-0 bg-black/80 backdrop-blur-sm flex items-start justify-center z-[80] overflow-y-auto p-0 sm:p-4">
