...
const RegisterModal = ({ onClose, onSuccess, onSwitchToSignIn }: RegisterModalProps) => {
  ...
  if (currentStep === 'otp') {
    return (
      <div data-reg="" className="fixed inset-0 bg-black/80 backdrop-blur-sm flex items-start justify-center z-[80] overflow-y-auto p-3 md:p-4">
        <div className="relative w-full max-w-[95%] sm:max-w-md">
          <button
            onClick={onClose}
            className="absolute -top-10 sm:-top-12 right-0 transition-colors" style={{color:"#9ca3af"}}
          >
          ...
          <div className="bg-gradient-to-br from-gray-900 via-gray-900 to-primary-900/30 rounded-xl sm:rounded-2xl shadow-2xl border border-gray-800/50 overflow-hidden backdrop-blur-xl">
            <div className="p-4 sm:p-6 md:p-8">
              <div className="text-center mb-6 sm:mb-8">
                ...
                <p className="text-xs sm:text-sm px-2" style={{color:"#9ca3af"}}>
                  Enter the 6-digit code sent to<br />
                  <span className="font-medium" style={{color:"#818cf8"}}>+{normalizePhoneNumber(formData.phoneNumber)}</span>
                </p>
              </div>
              ...
              <div className="space-y-4 sm:space-y-6">
                ...
                <div className="text-center">
                  {canResendOTP ? (
                    ...
                    <p className="text-xs sm:text-sm" style={{color:"#9ca3af"}}>
                      Resend OTP in <span className="font-medium" style={{color:"#818cf8"}}>{resendTimer}s</span>
                    </p>
                  )}
                </div>
                ...
                <button
                  ...
                  className="w-full text-xs sm:text-sm transition-colors" style={{color:"#9ca3af"}}
                >
          ...
          <div className="bg-gradient-to-br from-gray-900 via-gray-900 to-yellow-900/30 rounded-xl sm:rounded-2xl shadow-2xl border border-gray-800/50 overflow-hidden backdrop-blur-xl">
            <div className="p-4 sm:p-6 md:p-8">
              <div className="text-center mb-6 sm:mb-8">
                ...
                <p className="font-medium mt-2 text-sm sm:text-base" style={{color:"#818cf8"}}>
              ...
              <div className="text-center">
                ...
                {generatedUserId && (
                  <div className="bg-gray-800/60 backdrop-blur-xl rounded-lg sm:rounded-xl p-3 sm:p-4 mb-4 sm:mb-6 border border-gray-700/50">
                    <p className="text-xs sm:text-sm mb-1.5 sm:mb-2" style={{color:"#9ca3af"}}>Your Student ID</p>
                ...
                <p className="text-xs sm:text-sm mb-4 sm:mb-6 px-2" style={{color:"#d1d5db"}}>
                ...
                <p className="text-xs sm:text-sm mt-3 sm:mt-4" style={{color:"#9ca3af"}}>Redirecting to sign in...</p>
              </div>
            </div>
          </div>
        </div>
  ...
  // Render form step
  return (
    <div data-reg="" className="fixed inset-0 bg-black/80 backdrop-blur-sm flex items-start justify-center z-[80] overflow-y-auto p-0 sm:p-4">
        ...
        <div className="bg-gradient-to-br from-gray-900 via-gray-900 to-primary-900/30 sm:rounded-2xl shadow-2xl border-0 sm:border border-gray-800/50 overflow-hidden backdrop-blur-xl h-full sm:h-auto flex flex-col">
          <div className="p-4 sm:p-6 md:p-8 flex-1 overflow-y-auto" onScroll={handleScroll}>
            <div className="text-center mb-4 sm:mb-6 md:mb-8 pt-8 sm:pt-0">
              ...
              <p className="text-xs sm:text-sm px-2" style={{color:"#9ca3af"}}>Join us and start your learning journey</p>
            </div>
            ...
            <div className="space-y-3 sm:space-y-4 md:space-y-5">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-3 sm:gap-4 md:gap-5">
                <div className="group">
                  <label className="block text-xs sm:text-sm font-medium mb-1.5 sm:mb-2" style={{color:"#d1d5db"}}>Surname *</label>
                ...
                <div className="group">
                  <label className="block text-xs sm:text-sm font-medium mb-1.5 sm:mb-2" style={{color:"#d1d5db"}}>Full Name *</label>
                  <div className="relative">
                    <input
                      type="text"
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-3 sm:gap-4 md:gap-5">
                <div className="group">
                  <label className="block text-xs sm:text-sm font-medium mb-1.5 sm:mb-2" style={{color:"#d1d5db"}}>Date of Birth *</label>
                  <div className="relative">
                    <input
                      type="date"
                      value={formData.dob}
                ...
                <div className="group">
                  <label className="block text-xs sm:text-sm font-medium mb-1.5 sm:mb-2" style={{color:"#d1d5db"}}>Gender *</label>
                  <div className="relative">
                    <select
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-5">
                <div className="group">
                  <label className="block text-xs sm:text-sm font-medium mb-1.5 sm:mb-2" style={{color:"#d1d5db"}}>Phone Number *</label>
                  <div className="relative">
                    <input
                      type="tel"
                  ...
                  <p className="text-xs mt-1" style={{color:"#6b7280"}}>Bangladesh phone number</p>
                </div>

                <div className="group">
                  <label className="block text-xs sm:text-sm font-medium mb-1.5 sm:mb-2" style={{color:"#d1d5db"}}>Guardian Phone <span className="text-gray-500">(Optional)</span></label>
                  <div className="relative">
                    <input
                      type="tel"
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-5">
                <div className="group">
                  <label className="block text-xs sm:text-sm font-medium mb-1.5 sm:mb-2" style={{color:"#d1d5db"}}>Blood Group <span className="text-gray-500">(Optional)</span></label>
                  <div className="relative">
                    <select
                ...
                <div className="group">
                  <label className="block text-xs sm:text-sm font-medium mb-1.5 sm:mb-2" style={{color:"#d1d5db"}}>Class/Grade *</label>
                  <div className="relative">
                    <select
              ...
              <div className="group">
                <label className="block text-xs sm:text-sm font-medium mb-1.5 sm:mb-2" style={{color:"#d1d5db"}}>Religion <span className="text-gray-500">(Optional)</span></label>
                <input
                  type="text"
              ...
              <div className="group">
                <label className="block text-xs sm:text-sm font-medium mb-1.5 sm:mb-2" style={{color:"#d1d5db"}}>Address <span className="text-gray-500">(Optional)</span></label>
                <div className="relative">
                  <textarea
              ...
              <div className="group">
                <label className="block text-xs sm:text-sm font-medium mb-1.5 sm:mb-2" style={{color:"#d1d5db"}}>Email <span className="text-gray-500">(Optional)</span></label>
                <div className="relative">
                  <input
                    type="email"
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-5">
                <div className="group">
                  <label className="block text-xs sm:text-sm font-medium mb-1.5 sm:mb-2" style={{color:"#d1d5db"}}>Password *</label>
                  <div className="relative">
                    <input
              ...
              <button
                ...
                disabled={loading || duplicateCheckLoading || !captchaReady || !agreedToTerms || !agreedToPrivacy}
                className="w-full bg-gradient-to-r from-primary-600 via-purple-600 to-primary-600 hover:from-primary-700 hover:via-purple-700 hover:to-primary-700 disabled:from-gray-700 disabled:to-gray-800 disabled:cursor-not-allowed text-white py-3 sm:py-4 rounded-lg sm:rounded-xl transition-all duration-300 active:scale-95 flex items-center justify-center gap-2 font-semibold shadow-2xl hover:shadow-primary-500/50 text-sm sm:text-base"
              >
                {(loading || duplicateCheckLoading) && <Loader size={18} className="sm:w-5 sm:h-5 animate-spin" />}
                <span>
                  {duplicateCheckLoading ? 'Checking...' : loading ? 'Validating...' : !captchaReady ? 'Loading Security...' : 'Continue to Verification'}
                </span>
              </button>
            </div>
