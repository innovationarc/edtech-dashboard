...
const SignInModal = ({ onClose }: SignInModalProps) => {
  ...
  return (
    <div className="fixed inset-0 bg-black/70 backdrop-blur-md flex items-center justify-center z-50 p-4">
      {/* ZOOM-ONLY RESPONSIVENESS: Wrapper with scale transformation */}
      <div 
        className="w-full h-full flex items-center justify-center"
        style={{
          transform: 'scale(min(1, min(100vw / 580px, 95vh / 1000px)))',
          transformOrigin: 'center center',
        }}
      >
        <div 
          className="bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 rounded-2xl shadow-2xl border border-gray-700/50 overflow-y-auto relative"
          style={{
            width: '580px',
            maxHeight: '95vh',
          }}
