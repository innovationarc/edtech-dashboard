...
const ForgotPasswordModal = ({ onClose, onSuccess }: ForgotPasswordModalProps) => {
  ...
  const handleIdentifyUser = async () => {
    ...
    try {
      ...
      // Step 1: Identify user and get phone number (does NOT send OTP)
      ...
      if (result.success && result.phoneNumber) {
        ...
        // This ensures the correct SMS format is used
  ...
  const handleOTPPaste = (e: React.ClipboardEvent) => {
    ...
    if (pastedData.length === 6) {
      ...
      const nextInput = document.getElementById(`reset-otp-${pastedData.length}`);
      nextInput?.focus();
    }
  };
      ...
      <div className="fixed inset-0 bg-black/70 backdrop-blur-md flex items-center justify-center z-50 p-4">
        <div className="bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 rounded-3xl w-full max-w-md p-8 relative shadow-2xl border border-gray-700/50">
          ...
          <div className="relative">
            ...
            <h2 className="text-3xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-blue-400 via-purple-400 to-blue-500 mb-2 text-center">
              Create New Password
            </h2>
            ...
            <div className="space-y-5">
              ...
              <button
                ...
                disabled={loading || !newPassword || !confirmPassword || newPassword !== confirmPassword || !passwordStrength.isStrong}
