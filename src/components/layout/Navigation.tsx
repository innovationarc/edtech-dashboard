            ...
            {isAuthenticated && (
              <>
                ...
                <button 
                  ...
                  onMouseEnter={handleMouseEnterSidebarArea}
                  onMouseLeave={handleMouseLeaveSidebarArea}
                  className="group flex items-center justify-center w-11 h-11 rounded-xl hover:bg-white/[0.06] active:bg-white/[0.04] transition-all duration-200 ease-out active:scale-95 focus:outline-none [-webkit-tap-highlight-color:transparent]"
