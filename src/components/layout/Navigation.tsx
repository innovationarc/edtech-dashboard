    ...
    <>
      ...
      <header
        ...
        style={{
          ...
          fontFamily: "'Outfit', sans-serif",
          transform: location.pathname === '/notifications' ? 'translateY(-100%)' : 'translateY(0)',
          opacity: location.pathname === '/notifications' ? 0 : 1,
          pointerEvents: location.pathname === '/notifications' ? 'none' : 'auto',
