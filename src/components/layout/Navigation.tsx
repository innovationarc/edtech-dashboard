...
const Navigation = () => {
  ...
  const sbBg = darkMode
    ? `rgba(${(() => { const c = { dark:'13,16,23', slate:'15,23,42', ocean:'12,26,46', forest:'10,31,20', purple:'30,27,75', pink:'131,24,67', sunset:'28,10,0' }; return c[theme as keyof typeof c] || '13,16,23'; })()},0.92)`
  ...
  const hdrBg = darkMode
    ? `rgba(${(() => { const c = { dark:'13,16,23', slate:'15,23,42', ocean:'12,26,46', forest:'10,31,20', purple:'30,27,75', pink:'131,24,67', sunset:'28,10,0' }; return c[theme as keyof typeof c] || '13,16,23'; })()},0.96)`
