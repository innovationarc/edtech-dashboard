...
const Navigation = () => {
  ...
  return (
    <>
      ...
      >
        {/* Mobile Hamburger Button - Part of Sidebar */}
        <div className="lg:hidden p-3 border-b border-white/[0.06] flex-shrink-0">
          <button 
      ...
      {/* Floating Hamburger Button - Shows when sidebar is closed on mobile */}
      {!sidebarOpen && (
        <button
          onClick={toggleSidebarClick}
          className="lg:hidden fixed top-4 left-4 z-[101] flex items-center justify-center w-12 h-12 rounded-xl bg-gradient-to-br from-indigo-500 via-purple-500 to-purple-600 shadow-[0_4px_20px_rgba(99,102,241,0.4),0_0_0_1px_rgba(255,255,255,0.12)_inset] hover:shadow-[0_6px_24px_rgba(99,102,241,0.5)] active:scale-95 transition-all duration-200"
