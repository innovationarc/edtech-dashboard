  ...
  return (
    <Link
      ...
      style={{
        ...
        /* ── clean card highlight when active — matches iDraft ── */
        background: isActive
          ? darkMode
        ...
        /* Soft layer shadow — no glow */
        boxShadow: isActive
          ? darkMode
            ? `0 2px 8px rgba(0,0,0,0.3), 0 1px 0 rgba(255,255,255,0.06) inset`
            : `0 2px 8px rgba(0,0,0,0.15), 0 1px 0 rgba(255,255,255,0.5) inset`
          : 'none',
    ...
    >
      {/* ── icon bubble — clean, no glow ── */}
      <span
        className="flex items-center justify-center flex-shrink-0 rounded-xl"
        style={{
          width: 34, height: 34,
          background: isActive
            ? darkMode ? gradient : `rgba(17,24,39,0.85)`
            : isHovered
              ? darkMode ? `rgba(255,255,255,0.08)` : `rgba(0,0,0,0.07)`
              : darkMode ? 'rgba(255,255,255,0.05)' : 'rgba(0,0,0,0.05)',
          border: isActive
            ? darkMode ? '1px solid rgba(255,255,255,0.15)' : '1px solid rgba(255,255,255,0.2)'
            : isHovered
  ...
  return (
    <>
      ...
      <aside
        ...
        style={{
          /* Clean neutral sidebar — matches iDraft reference */
          background: darkMode
            ? 'rgba(13,16,26,0.98)'
      ...
      >
        ...
        <div className="flex-1 relative overflow-hidden">
          ...
          {/* Clean grouped section backdrop — neutral, not colorful */}
          {sidebarOpen && (
            <div className="absolute inset-x-2 inset-y-2 rounded-2xl pointer-events-none"
              style={{
                background: darkMode
        ...
        <div className="hidden lg:flex items-center justify-between w-full relative px-5 gap-4">
          ...
          {isAuthenticated && (
            <div className="flex items-center gap-2 flex-shrink-0">
              ...
              {/* Profile avatar — clean round chip */}
              <button onClick={() => setShowProfile(true)}
                className="flex items-center gap-2.5 pl-1 pr-2.5 py-1 rounded-xl transition-all duration-200"
                style={{
                  background: darkMode
                ...
                onMouseEnter={e => {
                  ...
                  e.currentTarget.style.borderColor = darkMode ? 'rgba(255,255,255,0.12)' : 'rgba(0,0,0,0.12)';
                }}
                onMouseLeave={e => {
                ...
                <div className="text-left hidden xl:block">
                  <p className="text-[13px] font-semibold leading-tight"
                    style={{ color: darkMode ? 'rgba(226,232,240,0.9)' : 'rgba(17,24,39,0.9)' }}>
                    {user?.name}
                  </p>
                </div>
              </button>
