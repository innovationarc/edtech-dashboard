...
const Navigation = () => {
  ...
  const handleItemHover = (itemName: string, event: React.MouseEvent<HTMLAnchorElement | HTMLButtonElement>) => {
    if (!sidebarOpen) {
  ...
  return (
    <>
      ...
      >
        ...
        <div className={clsx(
          ...
          <button
            ...
            onMouseEnter={(e) => user && handleItemHover(user.name, e)}
        ...
        {/* Navigation Items */}
        <nav className="flex-1 overflow-y-auto premium-scrollbar p-3 space-y-1" style={{ overflowX: 'visible' }}>
        ...
        <div className="flex-shrink-0">
          ...
          <div className="p-3">
            <button
              ...
              onMouseEnter={(e) => handleItemHover('Toggle Theme', e)}
              onMouseLeave={handleItemLeave}
              className={clsx(
      ...
      {/* Navigation Tooltips - Fixed Portal (Outside Scroll Container) */}
      {!sidebarOpen && hoveredItem && tooltipPosition && (
        <div 
        ...
        >
          <div className={clsx(
            "px-3 py-2 rounded-lg text-xs font-semibold whitespace-nowrap animate-in fade-in duration-200",
            darkMode 
