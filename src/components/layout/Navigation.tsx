...
const Navigation = () => {
  ...
  return (
    <>
      ...
      <header className="header-container fixed top-0 right-0 h-16 sm:h-[68px] lg:h-[72px] bg-gradient-to-b from-[#0a0e1a] to-[#0d1220] border-b border-white/[0.06] flex items-center justify-between px-4 sm:px-6 lg:px-8 xl:px-12 safe-area-top z-40 backdrop-blur-xl bg-opacity-95 shadow-[0_1px_0_0_rgba(255,255,255,0.03),0_8px_32px_-8px_rgba(0,0,0,0.4)]"
        style={{
