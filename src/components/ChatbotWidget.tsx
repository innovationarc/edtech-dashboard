    ...
    <>
      ...
      {voiceMode && (
        <div style={{
          position:'fixed',
          ...(isMobile
            ? { bottom:0, left:0, right:0, height:'100svh' } as React.CSSProperties
          ...
          {/* Bottom frosted bar */}
          <div style={{ position:'absolute',bottom:0,left:0,right:0,padding:isMobile?'8px 18px 14px':'8px 14px 12px',
      ...
      {isOpen && (
        ...
        >
          ...
          <div style={{ position:'relative',zIndex:3,flexShrink:0,
            padding: isMobile ? '10px 14px 14px' : '10px 12px 12px',
