...
const ChatbotWidget: React.FC<ChatbotWidgetProps> = ({ eyeOffset: _eyeOffset }) => {
  ...
  const handleVoiceSend = useCallback(()=>{
    ...
    stopListening();
    closeVoiceMode();
    if (text) setTimeout(()=>handleSendMessage(text),50);
      ...
      {voiceMode && (
        <div style={{
          ...
          ...(isMobile
            ...
            : { bottom:0, right:24, width:desktopPanelW, height:desktopPanelH, borderRadius:28 }),
          zIndex:10002,
          overflow:'hidden',
          background:'#040210',
          ...
          {/* Bottom frosted bar */}
          <div style={{ position:'absolute',bottom:0,left:0,right:0,padding:isMobile?'8px 18px calc(env(safe-area-inset-bottom,0px) + 12px)':'8px 14px 12px',
      ...
      {isOpen && (
        <div style={{
          ...
          ...(isMobile
            ...
            : { bottom:0, right:24, width:desktopPanelW, height:desktopPanelH,
        ...
        >
          ...
          <div style={{
            ...
            padding: isMobile ? 'calc(env(safe-area-inset-top,0px) + 0px) 8px 0 4px' : '0 10px 0 6px',
            paddingTop: isMobile ? 'calc(env(safe-area-inset-top,0px) + 0px)' : undefined,
            ...
            {/* Back button */}
            <button onClick={()=>setIsOpen(false)} aria-label="Go back"
              style={{ width:isMobile?50:42,height:isMobile?50:42,borderRadius:13,flexShrink:0,background:'transparent',
                border:'none',cursor:'pointer',display:'flex',alignItems:'center',justifyContent:'center',
                color:txtPri,WebkitTapHighlightColor:'transparent' }}
              ...
              <ChevronLeft size={isMobile?26:22} strokeWidth={2.4}/>
            </button>
            ...
            <div style={{ width:isMobile?40:34,height:isMobile?40:34,borderRadius:13,flexShrink:0,overflow:'hidden',
              ...
              boxShadow:`0 0 18px rgba(${pr},0.42)`,marginRight:10 }}>
            ...
            <div style={{ display:'flex',gap:2,flexShrink:0,alignItems:'center',paddingRight:4 }}>
              {isSpeaking && (
                <button onClick={stopSpeaking} title="Stop speaking"
                  style={{ width:38,height:38,borderRadius:11,background:`rgba(${ar},0.15)`,
              ...
              <button onClick={()=>setShowInfo(true)} title="About Aura"
                style={{ width:38,height:38,borderRadius:11,background:'transparent',border:'none',
                  cursor:'pointer',display:'flex',alignItems:'center',justifyContent:'center',
                  color:'rgba(255,255,255,0.35)',WebkitTapHighlightColor:'transparent' }}
          ...
          <div style={{ position:'relative',zIndex:3,flexShrink:0,
            padding: isMobile ? '10px 14px calc(env(safe-area-inset-bottom,0px) + 12px)' : '10px 12px 12px',
            ...
            <p style={{ fontSize:10,color:txtDim,textAlign:'center',margin:'5px 0 0',fontFamily:"'Outfit',sans-serif",letterSpacing:'0.06em',textTransform:'uppercase' }}>
