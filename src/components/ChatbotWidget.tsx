    ...
    <>
      ...
      {isOpen && (
        ...
        >
          ...
          {/* ── INPUT BAR — Claude-style: full-width flat, no inner container border ── */}
          <div style={{
            position:'relative', zIndex:3, flexShrink:0,
            padding: isMobile ? '12px 14px 16px' : '10px 12px 12px',
            ...
            <div style={{ display:'flex', alignItems:'center', gap:10 }}>
              <input ref={inputRef} type="text" className="nv-inp"
                ...
                style={{ flex:1, minWidth:0, background:'transparent', border:'none', color:txtPri,
                  fontSize:15, fontFamily:"'Outfit',sans-serif", padding:'6px 0', lineHeight:1.5,
              ...
              <button className={`nv-mic ${isListening?'listening':''}`}
                ...
                style={{ width:38, height:38, borderRadius:'50%', border:'none', cursor:'pointer', flexShrink:0,
                  background: isListening ? `rgba(${ar},0.18)` : dark ? 'rgba(255,255,255,0.08)' : 'rgba(0,0,0,0.06)',
              ...
              <button className="nv-send"
                ...
                style={{ width:38, height:38, borderRadius:'50%', border:'none', cursor:'pointer', flexShrink:0,
                  background: (!isLoading&&inputMessage.trim()) ? gradient : dark ? 'rgba(255,255,255,0.08)' : 'rgba(0,0,0,0.06)',
                  color:'#fff', display:'flex', alignItems:'center', justifyContent:'center',
                  opacity: (!isLoading&&inputMessage.trim()) ? 1 : 0.3,
                  boxShadow: (!isLoading&&inputMessage.trim()) ? `0 2px 14px rgba(${pr},.55)` : 'none',
