...
const ChatbotWidget: React.FC<ChatbotWidgetProps> = ({ eyeOffset: _eyeOffset }) => {
  ...
  const cardBdr = dark ? `rgba(${pr},0.18)` : `rgba(0,0,0,0.09)`;
  ...
  const bbAi   = cardBg;
  const bbAiBdr = dark ? `rgba(${pr},0.18)` : `rgba(0,0,0,0.09)`;
        ...
        >
          ...
          <div style={{
            ...
            <div style={{
              ...
              boxShadow: dark
                ? `0 2px 12px rgba(0,0,0,0.35), inset 0 1px 0 rgba(255,255,255,0.05)`
              ...
              <button className={`nv-mic ${isListening?'listening':''}`}
                ...
                style={{ width:36, height:36, borderRadius:'50%', border:'none', cursor:'pointer', flexShrink:0,
                  background: isListening ? `rgba(${ar},0.18)` : dark ? 'rgba(255,255,255,0.07)' : `rgba(${pr},0.08)`,
              ...
              <button className="nv-send"
                ...
                style={{ width:36, height:36, borderRadius:'50%', border:'none', cursor:'pointer', flexShrink:0,
                  background: (!isLoading&&inputMessage.trim()) ? gradient : dark ? 'rgba(255,255,255,0.07)' : `rgba(${pr},0.08)`,
