      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-8">
          ...
          <p className="text-gray-400 text-lg">
            Administrator Dashboard Profile
          </p>
        </div>
        ...
        <div className="bg-gray-800 rounded-lg p-8 border border-gray-700">
          <div className="text-center">
            ...
            <h2 className="text-2xl font-bold text-white mb-2">Admin Profile Page</h2>
            <p className="text-gray-400 mb-4">Role: {user?.role}</p>
            <p className="text-gray-500">This is a placeholder for the admin profile page.</p>
          </div>
        </div>
      </div>
    </div>
