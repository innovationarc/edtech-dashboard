...
// Download as PDF
// UPDATED handleDownloadPDF function - Ultra High Quality
// Replace lines 128-481 in your file with this complete function
...
const handleDownloadPDF = async () => {
  ...
  try {
    ...
    // Capture at ULTRA high resolution with maximum text sharpness
    const canvas = await html2canvas(cardRef.current, {
      scale: 10, // ULTRA HIGH scale for maximum sharpness
      useCORS: true,
      allowTaint: false,
      backgroundColor: '#ffffff',
      logging: false,
      ...
      onclone: (clonedDoc, element) => {
        // Remove any transforms or shadows
        element.style.transform = 'none';
        element.style.boxShadow = 'none';
        
        // Add ultra-sharp text rendering styles
