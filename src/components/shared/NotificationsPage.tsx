  ...
  const content = (
    <div style={{
      ...
      <div style={{
        ...
        padding: isMobile ? '7px 16px' : '7px 10px',
      }}>
            ...
            return (
              <button key={t.id} onClick={() => setTab(t.id)}
                ...
                style={{
                  ...
                  background:active?(dark?`rgba(${pRgb},0.22)`:`rgba(${pRgb},0.12)`):'transparent',
                  border:active?`1px solid rgba(${pRgb},0.35)`:'1px solid transparent',
