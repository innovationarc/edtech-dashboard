      ...
      <div style={{ position:'relative', overflow:'hidden', borderRadius:16, touchAction:'pan-y' }}>
        ...
        <div
          ...
          style={{
            ...
            userSelect:'none',
            background: dark
              ? (notif.isRead?'rgba(255,255,255,0.03)':'rgba(255,255,255,0.06)')
              : (notif.isRead?'rgba(255,255,255,0.85)':'#ffffff'),
        ...
        <div style={{ display:'flex',alignItems:'center',gap:6,flexShrink:0 }}>
          ...
          <div style={{ position:'relative' }}>
            <button
              ...
              <SlidersHorizontal size={15} color={filterOpen ? `rgb(${pRgb})` : dark?'#94a3b8':'#6b7280'}/>
