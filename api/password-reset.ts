...
interface PasswordResetRequest {
  ...
  resetByRole?: string;
  apiKey?: string;
  recaptchaToken?: string; // NEW: Optional - only used if provided
}
...
export default async function handler(
  ...
  try {
    ...
    // NOTE: recaptchaToken is intentionally NOT processed here
    // The original API doesn't validate reCAPTCHA
    // This keeps 100% backward compatibility with admin panel
